...
| 17 | [x] | `balance/drops/drop-table.json` | 掉落率權重配置 |
...
| 順序 | 狀態 | 檔案 | 說明 |
|:----:|:----:|------|------|
| 18 | [x] | `levels/maps/廢棄礦坑.md` | 白盒配置、怪物路線、高台位置 |
| 19 | [x] | `levels/maps/腐化森林.md` | 白盒配置、怪物路線、高台位置 |
| 20 | [x] | `levels/maps/星曜神殿.md` | 白盒配置、怪物路線、高台位置 |
